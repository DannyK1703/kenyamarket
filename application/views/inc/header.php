...
<head>
    ...
    <link href="<?= base_url('Assets/assets/css/animate.min.css') ?>" rel="stylesheet"/>

    <!--  Paper Dashboard core CSS    -->
    <link href="<?=base_url('Assets/assets/css/paper-dashboard.css')?>" rel="stylesheet"/>
    ...
    <link href="<?=base_url('Assets/assets/css/themify-icons.css')?>" rel="stylesheet">
